...
public interface RmModel {
     ...
     * @return java class
     * @throws com.marand.thinkehr.adl.rm.RmModelException if no such rm type exists
     */
     ...
     * @return type name
     * @throws com.marand.thinkehr.adl.rm.RmModelException if java class does not represent a rm type
     */
     ...
     * @throws com.marand.thinkehr.adl.rm.RmModelException if no such attribute exists
     */
